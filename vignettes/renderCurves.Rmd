...
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{renderAmpCurves and renderMeltCurves}
...
You can show *Cq* or *Tm* values on curves as markers setting `showCq = TRUE` or `showTm = TRUE`. Then input table have to contain *cq* or *tm* column, and *quantFluor* for **y** values.
...
Also curves can be hided or highlighted at the plot creation passing table with 
columns *hideCurve* and *highlightCurve* respectively.
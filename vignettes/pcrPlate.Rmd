...
To make CSS rule only for current plate add `#{{id}}` before CSS rule. For example if you want set selection border to red and well color to light yellow.
```{r, results='asis'}
pcrPlateInput(inputId = "customCSS", # Shiny input ID
              label = "Custom CSS: red selection and yellow plate background",
              plateDescription = rdml$AsTable(),
